...
DEFAULT_DB_PATH = os.getenv("ALFA_DB_PATH", os.path.join(REPO_ROOT, "agent_data.db"))
DB_PATH = DEFAULT_DB_PATH


def _resolve_db_path(custom_path: str | None = None) -> str:
...
def init_vector_db(db_path: str | None = None):
...
def _are_models_compatible(
    model_a: str | None, model_b: str | None, dim_a: int, dim_b: int
) -> bool:
...
def delete_document(
    user_id: int, doc_title: str, db_path: str | None = None
) -> dict[str, Any]:
